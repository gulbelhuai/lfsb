...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='瀹℃壒娴佺▼璁板綍琛';
...
CREATE TABLE `benefit_determination` (
  ...
  KEY `idx_create_time` (`create_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='寰呴亣鏍稿畾琛';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `distribution_batch` (
  ...
  KEY `idx_create_time` (`create_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='鍙戞斁鎵规?琛';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `person_key_info_modify` (
  ...
  KEY `idx_create_time` (`create_time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='人员关键信息修改申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='发放审核记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shebao_land_loss_resident` (
  ...
  KEY `idx_subsidy_person_id` (`subsidy_person_id`) USING BTREE,
  KEY `idx_recognition_time` (`recognition_time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='失地居民信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shebao_subsidy_distribution` (
  ...
  KEY `idx_approval_status` (`approval_status`) USING BTREE,
  KEY `idx_batch_type` (`batch_type`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='补贴发放记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1000021 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='被补贴人基础信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shebao_subsidy_person` VALUES (1000000,'高老汉','2','131131193411120001','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1934-11-12','河北廊坊','12321','13112345678','1',NULL,'1',1,2,'0010020001','0','0','admin','2025-09-28 01:49:29','admin','2025-10-20 00:44:29',NULL),(1000001,'刘三娘','2','131131198411120021','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1984-11-12','廊坊','12321','13012345678','1',NULL,'1',1,2,'0010020002','0','0','admin','2025-09-28 22:43:24','admin','2026-02-03 18:54:29',NULL),(1000002,'刘大娘','2','131131195611120005','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1956-11-12','廊坊','三里屯','13012345678','1',NULL,'1',2,3,'0020010001','0','0','admin','2025-09-28 22:59:15','admin','2025-10-20 00:42:21',NULL),(1000003,'王老五','2','131131195411120000','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1955-11-12','廊坊',NULL,'13012345678','1',NULL,'1',2,3,'0020010002','0','0','admin','2025-09-28 23:43:51','','2025-10-19 14:07:01',NULL),(1000004,'刘玉连','1','132801195611252658','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1956-11-25','河北省廊坊市','asdfadsf','130000000000','1',NULL,'1',1,1,'0010010001','0','0','admin','2025-10-11 10:58:40','admin','2025-10-20 00:44:07',NULL),(1000005,'高老汉','2','13280119450112452X','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1945-01-12','啊','和平区','13333333333','0','2026-02-01','1',1,1,'0010010002','0','0','admin','2025-10-11 16:28:26','admin','2026-02-03 15:07:53',NULL),(1000006,'大毛','2','13280119650112422X','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1965-01-12','河北','家里','13601243558','1','2025-10-20','1',1,1,'0010010003','0','0','admin','2025-10-19 13:55:31','admin','2025-10-19 15:13:58','123'),(1000015,'刘二娘','2','131131198411120004','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1984-11-12','廊坊','111','13012345678','1',NULL,'1',1,1,'0010010004','0','0','admin','2025-10-19 17:50:27','','2025-10-19 17:50:26',NULL),(1000016,'刘大娘','1','131131198411120012','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1984-11-12','廊坊','1111','13012345678','1',NULL,'1',1,1,'0010010005','0','0','admin','2025-10-19 17:54:10','','2025-10-19 17:54:26',NULL),(1000018,'张老汉','1','142725198101111110','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'2026-01-01','廊坊',NULL,'188110948483','0','2026-01-19','1',1,1,'0010010006','0','0','admin','2026-01-25 14:33:43','admin','2026-01-25 14:35:37',NULL),(1000019,'张一一','1','132801197209052622','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1972-09-05','第一村','第一村','13555556666','1',NULL,'1',1,1,'0010010007','0','0','admin','2026-01-30 09:20:23','admin','2026-02-03 15:07:12',NULL),(1000020,'测试张三','1','130102199001011234','uncertified',NULL,'0',NULL,NULL,NULL,NULL,'1990-01-01','河北省廊坊市银河南路街道第一村',NULL,'13800138000','1',NULL,'1',1,1,'0010010008','0','0','operator01','2026-03-02 16:36:54','','2026-03-02 16:36:54',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=289 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=350 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,100,'admin','超级管理员','00','ry@163.com','15888888888','1','','$2a$10$t/ws7qYp/wPm9b7jdNNaiuUTOmCmVTHo1mikBUM1zZ3NL3jfDha42','0','0','127.0.0.1','2026-03-03 01:36:10','2025-10-14 10:52:21','admin','2025-09-24 22:11:36','','2025-10-14 10:52:21','管理员'),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2025-09-24 22:11:36','2025-09-24 22:11:36','admin','2025-09-24 22:11:36','',NULL,'测试员'),(101,100,'operator01','经办人01','00','operator01@shebao.com','13800001001','0','','$2a$10$lzdKrbXy5Sm4XuOdjPO64u.41aaIsBsxSDfyBqF56htAujEqzG09S','0','0','127.0.0.1','2026-03-03 01:29:16','2026-03-02 16:06:28','admin','2026-01-19 10:08:28','','2026-03-02 16:06:28','经办人测试账号'),(102,100,'reviewer01','复核人01','00','reviewer01@shebao.com','13800001002','0','','$2a$10$V.GHUG0Pa4MeOk4oB9Yf9.ZrOTc.e7iQD2px0IKUJ7fKoxnNWjg0G','0','0','127.0.0.1','2026-03-03 01:31:30','2026-03-02 16:06:28','admin','2026-01-19 10:08:28','','2026-03-02 16:06:28','复核人测试账号'),(103,100,'approver01','审批人01','00','approver01@shebao.com','13800001003','0','','$2a$10$0UIkw8NxUh4lMYoLPpInle8zJGI6/Gb9U6g1wjVzMoOXTXSwBkwkK','0','0','127.0.0.1','2026-03-03 01:01:26','2026-03-02 16:06:29','admin','2026-01-19 10:08:28','','2026-03-02 16:06:29','审批人测试账号'),(104,100,'finance01','财务01','00','finance01@shebao.com','13800001004','0','','$2a$10$BjVUQ6xXFqdfVLDPt.QOZevWspj8p4Ug0oguDLDnB/YaOsz.5vJ66','0','0','127.0.0.1','2026-03-03 01:03:58','2026-03-02 16:06:29','admin','2026-01-19 10:08:28','','2026-03-02 16:06:29','财务人员测试账号'),(105,100,'auditor01','审计员01','00','auditor01@shebao.com','13800001005','0','','$2a$10$Af7ZvT/3p2WyqGF3zrIsMeS4A8vzHt8s2G4X3uj43XP2tjgGj4Btq','0','0','127.0.0.1','2026-03-03 01:33:49','2026-03-02 16:06:29','admin','2026-01-19 10:08:28','','2026-03-02 16:06:29','审计员测试账号');
...
-- Dump completed on 2026-03-03  0:33:06
