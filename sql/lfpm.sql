...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='瀹℃壒娴佺▼璁板綍琛';
...
CREATE TABLE `benefit_determination` (
  ...
  KEY `idx_create_time` (`create_time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='寰呴亣鏍稿畾琛';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `benefit_determination` VALUES (1,1000024,'land_loss_resident',2053,1,2053,2,NULL,'6222009876543210','全流程测试李四',600.00,0,0.00,'approved',NULL,'0',NULL,'2026-03-03 09:07:04',NULL,'2026-03-03 01:07:04',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='发放审核记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shebao_land_loss_resident` (
  ...
  KEY `idx_subsidy_person_id` (`subsidy_person_id`) USING BTREE,
  KEY `idx_recognition_time` (`recognition_time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='失地居民信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1000025 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='被补贴人基础信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=312 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=376 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-03  1:07:27
