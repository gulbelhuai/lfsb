...
ALTER TABLE `shebao_payment_plan`
  ADD COLUMN `finance_status` varchar(32) DEFAULT NULL COMMENT '财务状态(pending_finance/finance_pending_review/finance_pending_approve/finance_approved)' AFTER `approval_status`;
